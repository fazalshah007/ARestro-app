...
import { getSingleProduct, updateProduct } from '@/http/AllRequestFromServer';
...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        setLoading(true)
            ...
            try {
                ...
                setToppings([...singleProduct?.data?.data?.toppings])
                setOptionSize([...singleProduct?.data?.data?.sizeOptions])
                setFetchedProductData(singleProduct?.data)
                setLoading(false)
    ...
    useEffect(() => {
        ...
        reset({
            name: fetchedProductData?.data.title || "",
            description: fetchedProductData?.data.description || "",
            price: String(fetchedProductData?.data.price) || "",
        })
    },[fetchedProductData?.message, reset])
                    ...
                    <div className='w-full'>
                        <Card className="p-4">
                            <CardHeader>
                                ...
                                <CardDescription>update a product with existing specifications</CardDescription>
                            </CardHeader>
                            <CardContent>
                                    ...
                                    <div className='flex-2 '>
                                        ...
                                        <div className='my-4'>
                                            ...
                                            <div className='w-full flex gap-4 justify-between'>
                                                ...
                                                <Select
                                                    onValueChange={(e) => setOnCategory(e)}
                                                >
                                ...
                                <div>
                                    <Button onClick={handleSubmit(handleSubmitProduct)} className="text-lg my-4 bg-astro-green hover:bg-astro-light" >Update Product</Button>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
